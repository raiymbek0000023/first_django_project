...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\User\Desktop\project\.venv'
    let bin = 'Scripts'
    let path_sep = ';'
    ...
    let virtual_prompt = if ('project-py3.9' == '') {
...
alias deactivate = source 'C:\Users\User\Desktop\project\.venv\Scripts\deactivate.nu'
